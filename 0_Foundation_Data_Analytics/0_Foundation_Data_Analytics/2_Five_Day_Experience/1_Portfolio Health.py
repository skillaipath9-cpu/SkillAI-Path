...
student_name = dbutils.widgets.get("Name")
student_id = dbutils.widgets.get("StudentID")
...
payload = {
    ...
    "day": day,
    "case": "PH",
    "event": "NOTEBOOK_STARTED"
}

requests.post(
    "https://script.google.com/macros/s/AKfycbzIjU6QigydarDE2SCDEtJm8itZeEaYy8zkS7ZGqYoW4xH4S_2UxiLUt5h4uynKaQQK/exec",
    json=payload
)
